...
public:
   ...
   void insertMiddle( const NODETYPE &, const int );
   bool removeFromFront( NODETYPE & );
   bool removeFromBack( NODETYPE & );
   bool removeMiddle( NODETYPE &, const int );
   bool isEmpty() const;
   void print() const;
...
void List< NODETYPE >::insertAtBack( const NODETYPE &value )
{
  ...
  template< class NODETYPE >  
  void List< NODETYPE >::insertMiddle( const NODETYPE & value, const int position)
  {
...
bool List< NODETYPE >::removeFromBack( NODETYPE &value )
{
  ...
  template< class NODETYPE >  
  bool List< NODETYPE >::removeMiddle( NODETYPE & value, const int position)
  {
	...
	else if(firstPtr == lastPtr && position > 1)
		return false;
	else{
		int count = 1; 
		ListNode< NODETYPE > *currentPtr = firstPtr;
